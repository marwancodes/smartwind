import { HeadphonesIcon, MinusIcon, PlusIcon, ShoppingCartIcon, Trash2Icon, LogInIcon } from "lucide-react";
  ...
  return (
    <div className="text-left">
        ...
        {items.length === 0 ? (
            ...
            <PageError message="Could not load product details. Refresh the page or try again shortly." action={undefined} />
        ) : (
